...
- **[DOWNLOAD_GUIDE.md](DOWNLOAD_GUIDE.md)** - How to download and setup from Figma Make
- **[LOCAL_SETUP.md](LOCAL_SETUP.md)** - Complete local development guide
- **[API_MAPPING.md](API_MAPPING.md)** - Frontend ↔ Flask ↔ Supabase mapping
- **[COMPREHENSIVE_DOCUMENTATION.md](COMPREHENSIVE_DOCUMENTATION.md)** - Every feature, journey, and decision
- **[CONDA_SETUP_GUIDE.md](CONDA_SETUP_GUIDE.md)** - Conda/Miniconda environment setup
...
```bash
cd backend
# Configure with Procfile or railway.json
...
- Run migration for rental status constraint:
  ```sql
  ...
  CHECK (status IN ('pending', 'confirmed', 'active', 'pending_return', 'completed', 'rejected', 'cancelled'));
  ```
...
Built with ❤️ by the Tarumbeta Team
...
- [x] Instrument listings & browsing
- [x] Rental lifecycle (7 statuses)
- [x] Owner Dashboard
- [x] Learner Dashboard
- [x] Instructor profiles
- [x] ML matching algorithm
- [x] Lesson scheduling
- [x] Review system
...
- [ ] Partner program (music schools)
- [ ] Marketplace for instruments (buy/sell)
- [ ] Virtual instrument trials (AR/VR)
- [ ] Group lessons
...
- **Email:** support@tarumbeta.com (placeholder)

---

## ⭐ Star Us!

If you find Tarumbeta helpful, please star this repository! It helps others discover the project.
